      ...
      <div className="grid grid-cols-2 gap-4">
        <div className='col-span-1'>
          ...
          <p className='text-gray-500'>
            Custom regulations for India require a copy of the recipient's KYC. The address on the KYC needs to match the shipping address. Our courier will contact you via SMS/email to obtain a copy of your KYC. The KYC will be stored securely and used solely for the purpose of clearing customs for all orders and returns. If your KYC does not match your shipping address, please click the link for more information.
            <a className='underline text-gray-500' href='#'>Learn More</a>
          </p><br/>
          <div className='flex items-center deliver border border-black rounded-xl border-solid border-2 w-30 h-14 p-1'>
