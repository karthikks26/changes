        ...
        <>
            <form onSubmit={handleData} className="w-1/2">
                ...
                <div className="mb-4">
                    ...
                    <input type="text"
                        onChange={handlefunc} name="first" placeholder="first name"
                        value={form.first} className="px-5 form-input border border-gray-600 h-10 sm:w-96 w-[70vw] rounded-md" //for controlled components               
                    />
                ...
                <div className="mb-4">
                    ...
                    <input type="text"
                        onChange={handlefunc} name="last" placeholder="Last Name"
                        value={form.last} className="px-5 form-input border border-gray-600 h-10 sm:w-96 w-[70vw] rounded-md"
                    />
                ...
                <div className="mb-4">
                    ...
                    <input type="text"
                        onChange={handlefunc} name="add1" placeholder="Address Line 1"
                        value={form.add1} className="px-5 form-input border border-gray-600 h-10 sm:w-96 w-[70vw] rounded-md" />
                    {/* <span className="text-lg absolute left-36 pt-1 transition duration-200 input-text text-gray-300">Address Line 1</span> */}

                    <h6 className="text-xs text-blue-600 ">We do not ship to P.O. boxes</h6>
                </div>
                <div className="mb-4">  
                    <label htmlFor="add2" className="form-label relative"></label><br />
                    <input type="text"
                        onChange={handlefunc} name="add2" placeholder="Address Line 2" className="px-5 form-input border border-gray-600 h-10 sm:w-96 w-[70vw] rounded-md"
                        value={form.add2} />
                ...
                <div className="mb-4">
                    ...
                    <input type="text"
                        onChange={handlefunc} name="add3" placeholder="Address Line 3"
                        value={form.add3} className="px-5 form-input border border-gray-600 h-10 sm:w-96 w-[70vw] rounded-md"
                    />
                ...
                <div className="mb-4">
                    ...
                    <input type="email" placeholder="Email"
                        ...
                        value={form.email} className="px-5 form-input border border-gray-600 h-10 sm:w-96 w-[70vw] rounded-md "
                    />
                    {/* <span className="text-lg absolute left-36 pt-1 transition duration-200 input-text text-gray-300">Email</span> */}

                    <h6 className="text-xs w-[70vw]">A confirmation mail will be sent after checkout.</h6>
                </div>
                <div className="mb-4">
                    <label htmlFor="number" className="form-label relative"></label><br />
                    <input type="number"
                        onChange={handlefunc} name="number" placeholder="Mobile Number"
                        value={form.number} className="px-5 form-input border border-gray-600 h-10 sm:w-96 w-[70vw] rounded-md"
                    />
                    {/* <span className="text-lg absolute left-36 pt-1 transition duration-200 input-text text-gray-300">Phone Number</span> */}

                    <h6 className="text-xs w-[70vw]">A carrier might contact you to confirm delivery.</h6>
                </div>
                <div className="mb-4">
                    ...
                    <input type="text" placeholder="PAN"
                        ...
                        value={form.pan} className="px-5 form-input border border-gray-600 h-10 sm:w-96 w-[70vw] rounded-md"
                    />
                    {/* <span className="text-lg absolute left-36 pt-1 transition duration-200 input-text text-gray-300">PAN</span> */}

                    <h6 className="text-xs w-[70vw]">Enter your PAN to enable payment with UPI,Net Banking or local card methods.</h6>
                </div><br />
                ...
                <button  className="mt-4 bg-black text-white py-2 px-4 rounded-full sm:w-96 w-[70vw] ">Continue</button>
            </form>
            <br /><br /><hr />
        </>
    )
